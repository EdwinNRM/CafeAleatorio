...
export default () => {
  return (
    <div className="h-20 bg-zinc-900 flex items-center justify-center px-14 flex-row shadow-2xl">
      ...
      <span className="text-3xl font-nsmono font-semibold ml-10 text-zinc-50">
        Café Aleatôrio
      </span>
      {/* <button 
